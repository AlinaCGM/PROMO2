      ...
      <div class='row pictures justify-content-center '>
        ...
        <div class='col-12 col-md-6 col-lg-6 colum-about  '>
          <p className='information-about '>
            ...
            malesuada molestie nulla, vel hendrerit nulla suscipit sed. Donec
            diam leo, efficitur sit amet finibus ac, laoreet in est. Maecenas at
            velit in diam eleifend iaculis. Vivamus sit amet justo commodo,
            rutrum ante et, suscipit magna. Ut ullamcorper eu augue a tempor.
            Phasellus aliquet ex odio, eu ullamcorper enim molestie rhoncus.
            Donec et consequat velit.
          </p>
        </div>
      </div>

      <div className='small-about col-12  colum-about '></div>
